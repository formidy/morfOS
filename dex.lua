...
--[[
	...
	mOS Explorer is a revival of Moon's Dex, made to fulfill Moon's Dex prophecy.
]]
...
Main = (function()
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="mOS Explorer",TextColor3=Color3.new(1,1,1),TextSize=50,TextTransparency=1,}},
	...
	Main.SetMainGuiOpen = function(val)
		...
		Main.MainGui.OpenButton.Text = val and "Close" or "mOS Explorer"
